...
#include "../headers/heads.hpp"
#include "../headers/basics.hpp"
#include "../headers/ownFuncs.hpp"
...
{
  Table aux = db;
  char primary[100] = "PRIMARY_KEY", empty[100] = "EMPTY", not_empty[100] = "NOT_EMPTY", _any[100] = "ANY";
  char _character[100] = "character", _integer[100] = "integer";
        ...
        !strcmp(tipoCol, _character)))
  {
    ...
    cout << '\t' << "Tipos de dato: integer, character" << endl
         << endl;
    return ERROR;
  }
  ...
  int integerValue = 1;
  aux->pointer->valChar = new char[100];
